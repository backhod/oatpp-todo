...
#include <iostream>
oatpp::Object<TodoDto> TodoService::createTodo(
    const oatpp::Object<CreateTodoDto>& todo,
    const oatpp::Int32& timestamp) {
...
oatpp::Object<TodoDto> TodoService::getTodoById(
...
oatpp::Object<TodoDto> TodoService::updateTodo(
    const oatpp::Object<UpdateTodoDto>& todo,
    const oatpp::Int32& id) {
